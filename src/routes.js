...
const NewEditor = React.lazy(() => import('./views/Editors/CreateNewEditor'))
...
const NewPackage = React.lazy(() => import('./views/Packages/CreateNewPackage'))
